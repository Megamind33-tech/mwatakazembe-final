...
export const rulerProfiles = {
  1: {
    ...
    culturalNote: "Umutomboko later commemorates this arrival and installation memory as a dance of victory.",
  ...
  5: {
    historicalRole: "Reign in a period of succession pressure and fragmentary public records.",
    keyEvents: ["Accessible published lineage tables disagree on the identity of Mwata Kazembe V."],
    governance: "Details to be verified against kingdom records.",
    warsDiplomacyTrade: "",
    culturalNote: "",
    sourceNote: "Uncertain — Gordon and lineage references require reconciliation."
  },
  6: {
  ...
  19: {
    ...
    keyEvents: [
      "Listed as Paul Mpemba Kanyembo Kapale Mpalume from 1998 onward in public lineage references.",
...
export function enrichKing(king) {
  const profile = rulerProfiles[king.id];
  if (!profile) return king;
  return { ...king, profile };
}

export function enrichKings(list) {
  return list.map(enrichKing);
}
