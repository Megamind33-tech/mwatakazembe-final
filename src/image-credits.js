...
export const imageCredits = [
  ...
  },
  {
    ...
    description:
      "Historical portrait of Muonga 'Kamwefu' Kapakata, Mwata Kazembe XI (reign 1904–1919), in beaded headdress and ceremonial beads. The published caption matches the Kingdom's lineage record for Mwata Kazembe XI.",
    ...
    altText: "Black-and-white portrait of Mwata Kazembe XI Muonga Kapakata in a beaded headdress.",
  ...
  },
  {
    ...
    title: "A Mwata Kazembe with the staff of office",
    description:
      "Historical black-and-white photograph of a Mwata Kazembe in a beaded headband holding the royal staff of office, with attendants behind. The specific officeholder and date are to be confirmed.",
    ...
    altText: "Black-and-white photograph of a Mwata Kazembe holding a tall royal staff.",
    sectionUsedIn: "Office of the Mwata — Historical continuity, Gallery",
    category: "archive",
    imageType: "historical photograph",
    verificationStatus: "needs-confirmation",
  ...
  },
  {
    ...
    description:
      "Black-and-white photograph of a royal ceremony at Kazembe during the colonial period — a Mwata Kazembe in regalia, officials, and a colonial officer in dress uniform, with Union Jack bunting and a large crowd. The exact event and year are to be confirmed (consistent with the c. 1961 era).",
    sourceName: "Historical archive (supplied for the Kingdom website)",
    sourceUrl: "",
    photographerOrCredit: "Historical photograph",
    dateAccessed: "2026-06-03",
  ...
  },
  {
    ...
    title: "The Mwata Kazembe in the beaded ceremonial crown",
    description:
      "The Mwata Kazembe wearing the beaded ceremonial crown, seated among attendants at a Kingdom gathering.",
    ...
    altText: "The Mwata Kazembe wearing a blue-and-white beaded crown, seated among attendants.",
    sectionUsedIn: "Office of the Mwata, Gallery",
    category: "mwata",
  ...
  },
  {
    ...
    title: "The Mwata Kazembe in white ceremonial dress",
    description:
      "The Mwata Kazembe in white ceremonial dress and royal beads, holding a fly-whisk, in conversation with a senior court figure during a ceremony.",
    sourceName: "Supplied for the Kingdom website",
    sourceUrl: "",
    photographerOrCredit: "Source to be confirmed",
    dateAccessed: "2026-06-03",
    licenseOrUsageNote: "Image supplied for the project; original photographer and rights to be confirmed.",
    altText: "The Mwata Kazembe in white ceremonial dress and beads holding a fly-whisk.",
    sectionUsedIn: "Office of the Mwata, Gallery",
    category: "mwata",
    imageType: "documentary",
    verificationStatus: "needs-confirmation",
  ...
  },
  {
    ...
    title: "Royal procession on the Muselo litter, Mwansabombwe",
    description:
      "A royal procession carried on the Muselo litter through Mwansabombwe, passing the district ceremonial grounds, with a large crowd in attendance.",
    sourceName: "Supplied for the Kingdom website",
    sourceUrl: "",
    photographerOrCredit: "Source to be confirmed",
    dateAccessed: "2026-06-03",
    licenseOrUsageNote: "Image supplied for the project; original photographer and rights to be confirmed.",
    altText: "A figure carried on a green-draped bamboo litter through a crowd at Mwansabombwe.",
    sectionUsedIn: "Mutomboko Ceremony, Gallery",
    category: "ceremony",
    imageType: "documentary",
    verificationStatus: "needs-confirmation",
  ...
  },
  {
    ...
    title: "Ceremony crowd at Mwansabombwe",
    description:
      "Crowds gathered at the Mwansabombwe ceremonial grounds during a Kingdom ceremony, with the district monument visible in the background.",
    sourceName: "Supplied for the Kingdom website",
    sourceUrl: "",
    photographerOrCredit: "Source to be confirmed",
    dateAccessed: "2026-06-03",
    licenseOrUsageNote: "Image supplied for the project; original photographer and rights to be confirmed.",
    altText: "A large crowd gathered at the Mwansabombwe ceremonial grounds.",
    sectionUsedIn: "Mutomboko Ceremony, Gallery",
    category: "ceremony",
    imageType: "documentary",
    verificationStatus: "needs-confirmation",
  ...
  },
  {
    ...
    title: "Royal women in Lunda-Kazembe ceremonial dress",
    description:
      "Senior royal women in full ceremonial dress in the red, white, and blue of the Kingdom, gathered at a Kingdom occasion.",
    sourceName: "Supplied for the Kingdom website",
    sourceUrl: "",
    photographerOrCredit: "Source to be confirmed",
    dateAccessed: "2026-06-03",
    licenseOrUsageNote: "Image supplied for the project; original photographer and rights to be confirmed.",
    altText: "Royal women in red, white, and blue ceremonial skirts and red caps at a gathering.",
    sectionUsedIn: "People of the Kingdom, Gallery",
    category: "people",
    imageType: "documentary",
    verificationStatus: "needs-confirmation",
