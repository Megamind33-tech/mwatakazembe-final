...
export const imageCredits = [
  ...
  },
  {
    ...
    title: "A past Mwata Kazembe with the royal staff of office",
    description:
      "Historical photograph of a past Mwata Kazembe bearing the royal staff of office, with members of the royal court in attendance. The specific officeholder and date are to be confirmed with the Royal Protocol Office.",
    ...
    altText: "Historical photograph of a past Mwata Kazembe bearing the royal staff of office.",
    sectionUsedIn: "Office of the Mwata — Historical continuity, Gallery",
    category: "archive",
    imageType: "historical photograph",
    verificationStatus: "needs-confirmation",
  ...
  },
  {
    ...
    title: "A Mwata Kazembe during the Mutomboko ceremony",
    description:
      "A Mwata Kazembe in the white ceremonial attire worn during the Mutomboko ceremony, bearing the royal fly-whisk, with a senior member of the royal court.",
    sourceName: "Supplied for the Kingdom website",
    sourceUrl: "",
    photographerOrCredit: "Source to be confirmed",
    dateAccessed: "2026-06-03",
    licenseOrUsageNote: "Image supplied for the project; original photographer and rights to be confirmed.",
    altText: "A Mwata Kazembe in white ceremonial attire during the Mutomboko ceremony.",
    sectionUsedIn: "Mutomboko Ceremony, Gallery",
    category: "ceremony",
