export const sources = [
  {
    ...
    note: "Official tourism summary: location, annual timing, two-day structure, Kola migration memory, and the meaning of Umutomboko as a dance of conquest."
  },
  {
    id: "unza",
    type: "academic",
  ...
  },
  {
    ...
    note: "Reusable media category containing the Kazembe map, 2017 ceremony photographs, and a 1961 Mwata Kazembe XVII photograph."
  },
  {
    id: "commons-current",
    type: "media",
  ...
  },
  {
    ...
    note: "Outside lineage reference, corroborating the record of the Kingdom for the reigns listed here."
  },
  {
    id: "gordon",
    type: "academic",
...
export const artifacts = [
  ...
  },
  {
    ...
    meaning: "The sword and axe embody conquest, protection, and the Mwata's public statement of authority during the dance of conquest.",
...
export const kings = [
  ...
  { id: 4, name: "Tishibangu Keleka Mozi", reign: "1805-1850", title: "Mwata Kazembe IV", era: "trade", confidence: "archive-supported", note: "Encouraged contact with Portuguese traders and the copper/ivory trade world.", sources: ["smithsonian"] },
  { id: 5, name: "Muonga Kapumba Mfwama Kasawo Muonga I", reign: "c. 1850-1854", title: "Mwata Kazembe V", era: "trade", confidence: "lineage record", note: "Short reign at the onset of the mid-century slowdown in Kazembe trade.", sources: ["gordon"] },
  { id: 6, name: "Chinyanta Munona", reign: "1854-1862", title: "Mwata Kazembe VI", era: "trade", confidence: "oral and colonial record", note: "Granted Msiri leave to settle in Katanga in 1856, a turning point in the kingdom's fortunes.", sources: ["gordon"] },
  { id: 7, name: "Muonga Nsemba", reign: "1862-1870", title: "Mwata Kazembe VII", era: "trade", confidence: "archive-supported", note: "Associated with David Livingstone's 1867-1868 visit to the Kazembe court.", sources: ["smithsonian"] },
  { id: 8, name: "Chinkonkole Kafuti", reign: "1870-1872", title: "Mwata Kazembe VIII", era: "trade", confidence: "period record", note: "Brief reign during the instability that followed the killing of a Mwata Kazembe in 1870.", sources: ["gordon"] },
  { id: 9, name: "Lukwesa Mpanga", reign: "1872-1883 / 1885-1886", title: "Mwata Kazembe IX", era: "colonial", confidence: "contested dates", note: "Disputed reigns reflect succession conflict under mounting outside pressure.", sources: ["gordon"] },
  ...
  { id: 11, name: "Muonga Kapakata", reign: "1904-1919", title: "Mwata Kazembe XI", era: "colonial", confidence: "colonial period", note: "Ruled during early indirect administration and mission-era change.", sources: ["gordon"] },
  ...
  { id: 15, name: "Brown Ngombe", reign: "1950-1957", title: "Mwata Kazembe XV", era: "independence", confidence: "twentieth-century record", note: "Reigned through the rise of mass nationalism and the Central African Federation.", sources: ["gordon"] },
  { id: 16, name: "Kanyembo Kapema", reign: "1957-1961", title: "Mwata Kazembe XVI", era: "independence", confidence: "twentieth-century record", note: "Held the final reign before Zambian independence.", sources: ["gordon"] },
  ...
  { id: 19, name: "Paul Mpemba Kanyembo Kapale Mpalumena", reign: "1998-present", title: "Mwata Kazembe XIX", era: "contemporary", confidence: "current office", note: "Installed in 1998. Presides over Umutomboko and carries the Kingdom in regional and cross-border Lunda relations.", sources: ["kazembe-lineage", "commons-current", "zta", "unza"] }
];
...
export const sourceClaims = [
  ...
  { claim: "Mwata Kazembe XIX, Paul Mpemba Kanyembo Kapale Mpalumena, was installed in 1998 and reigns today.", sources: ["kazembe-lineage"], type: "verified" },
